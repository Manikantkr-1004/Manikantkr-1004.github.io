...
const Projects = ({theme})=>{
    ...
    let arr = [
        ...
        {days:": 05 Days",pro:"Individual Project",stack:[" Angular | ","Tailwind | ","FlowBite | ","Node JS | ","Express JS | ","Mongo DB"],name:"BookHub",image:bookhub, des:"BookHub is a sophisticated online platform combining a feature-rich bookstore with a lively reading community, AI-powered, employing Angular for an immersive frontend experience.",link:"https://bookhubymani.netlify.app/",git:"https://github.com/Manikantkr-1004/BookHub"},
