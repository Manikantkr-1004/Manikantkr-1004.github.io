...
import { FaGithub, FaLinkedin, FaPhoneAlt, FaEnvelope, FaDownload } from "react-icons/fa";
    ...
    direction={{base:"column-reverse", sm:"column-reverse", md:"column-reverse",lg:"row",xl:"row"}}>
        <div>
           ...
           justifyContent="space-between" alignItems="center">
            <Button textDecoration="none" _hover={{background:"white", color:"#FE9119"}} background="#FE9119" color="#000" border="2px solid #FE9119" display={'flex'} alignItems={'center'} justifyContent={'center'} borderRadius="50%" variant="unstyled"><a href="https://github.com/Manikantkr-1004" target="_blank" rel="me noopener"><FaGithub size={'20px'} /></a></Button>
            <Button _hover={{background:"white", color:"#FE9119"}} background="#FE9119" color="#000" border="2px solid #FE9119" display={'flex'} alignItems={'center'} justifyContent={'center'} borderRadius="50%" variant="unstyled"><a href="https://www.linkedin.com/in/manikantofficial2023" target="_blank" rel="noopener"><FaLinkedin size={'19px'} /></a></Button>
            <Button _hover={{background:"white", color:"#FE9119"}} background="#FE9119" color="#000" border="2px solid #FE9119" display={'flex'} alignItems={'center'} justifyContent={'center'} borderRadius="50%" variant="unstyled"><a href="tel:+918102675820" target="_blank"><FaPhoneAlt /></a></Button>
            <Button _hover={{background:"white", color:"#FE9119"}} background="#FE9119" color="#000" border="2px solid #FE9119" display={'flex'} alignItems={'center'} justifyContent={'center'} borderRadius="50%" variant="unstyled"><a href="mailto:manikantobra@gmail.com" target="_blank"><FaEnvelope size={'17px'} /></a></Button>
           </Flex>

           <br/>

           <Button onClick={downloadResume} id="resume-button-2" rightIcon={<FaDownload />} _hover={{background:"none", color:"#FE9119",transform:"rotate(-3deg)"}} 
